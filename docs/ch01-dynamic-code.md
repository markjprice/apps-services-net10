...
Assembly metadata:
  ...
  Location: C:\apps-services-net10\Chapter01\WorkingWithReflection\bin\Debug\net10.0\WorkingWithReflection.dll
  Entry point: <Main>$
...
```
Assembly metadata:
  Full name: WorkingWithReflection, Version=10.0.1.0, Culture=neutral, PublicKeyToken=null
  ...
  Version: 10.0.1
...
9.	Copy the three files from the `DynamicLoadAndExecute.Library` project's `bin\Debug\net10.0` folder to the equivalent folder in the `DynamicLoadAndExecute.Console` project, as shown in the following list:
...
Location: C:\apps-services-net10\Chapter01\DynamicLoadAndExecute.Console\bin\Debug\net10.0
IsCollectible: False
Defined types:
...
3. In the `obj/Debug/net10.0` folder, note the `generated` folder and its subfolder `GeneratingCodeLib/Packt.Shared.MessageSourceGenerator`, and the auto-generated file named `Program.Methods.g.cs`.
...
https://github.com/markjprice/apps-services-net10/blob/main/book-links.md#chapter-1c---controlling-the-roslyn-compiler-reflection-and-expression-trees
