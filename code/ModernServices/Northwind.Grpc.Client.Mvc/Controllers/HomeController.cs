...
using Google.Protobuf.Collections; // To use RepeatedField<T>.
...
namespace Northwind.Grpc.Client.Mvc.Controllers
{
  public class HomeController : Controller
  {
    ...
    public async Task<IActionResult> Products(decimal minimumPrice = 0M)
    {
      ...
      RepeatedField<ProductReply> products = reply.Products;
    ...
    public async Task<IActionResult> Employees()
    {
      ...
      RepeatedField<EmployeeReply> employees = reply.Employees;
